(function () {
    ...
    angular
        ...
        .controller('DriverTimetableRoutelistDetailsController', DriverTimetableRoutelistDetailsController);

    DriverTimetableRoutelistDetailsController.$inject = ['NgMap', '$scope', '$stateParams', '$timeout', 'Checkpoint', 'Waybill'];

    function DriverTimetableRoutelistDetailsController(NgMap, $scope, $stateParams, $timeout, Checkpoint, Waybill) {
        var vm = this;
