...
(function () {
    ...
    function stateConfig($stateProvider) {
        $stateProvider
            ...
            /*.state('companyowner.routelist', {
                parent: 'companyowner',
                url: '/companyowner/routelists/:id',
                ...
                views: {
                    'page@companyowner': {
                        templateUrl: 'app/companyowner/routelists/companyowner.routelist.html',
                        controller: 'CompanyownerRouteListController',
                        controllerAs: 'vm'
                    }
                },
                resolve: {
