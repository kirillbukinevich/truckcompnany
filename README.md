...
- Go to the folder <'solr_directory'>/server/solr/storages/conf. The folder containts file "managed-schema". You have togit checkout  delete it.
...
To optimize the TruckCompany application for production, run:
